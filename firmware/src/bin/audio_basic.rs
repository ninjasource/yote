    ...
    loop {
        if play_state.is_playing() {
            ...
            if tone_playing.load(Ordering::SeqCst) {
                ...
                // TODO: perform heavy cpu compute task on input buffer
                // at a sampling rate of 48khz we have about 650us to process 32 samples in our buffer.
                // for now just copy mic input to output
